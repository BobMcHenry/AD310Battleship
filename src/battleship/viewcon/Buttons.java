...
class Buttons {
    ...
    VBox makeShipButtons1() {
        ...
        /**
        Button bs = new Button("BattleShip");
        Button ac = new Button("Aircraft Carrier");
        Button cr = new Button("Cruiser");
        Button ds1 = new Button("Destroyer");
        Button ds2 = new Button("Destroyer");
        Button sb1 = new Button("Submarine");
        Button sb2 = new Button("Submarine");
        Button sb3 = new Button("Submarine");
